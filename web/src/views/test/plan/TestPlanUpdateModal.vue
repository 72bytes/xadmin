...
import { getTestPlan, updateTestPlan } from '@/apis/test/plan'
...
const [form, resetForm, setForm] = useResetReactive({
  name: '',
  code: '',
  description: '',
  startTime: '',
...
const loadData = async (id: string) => {
  try {
    ...
    setForm({
      ...
      testEnv: res.data.testEnv,
      relatedProject: res.data.relatedProject,
...
const save = async () => {
  try {
    ...
    await updateTestPlan(form, dataId.value)
